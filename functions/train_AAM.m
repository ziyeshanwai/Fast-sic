...
disp("A.Read shapes and Apply Procrustes to remove scale-rotation-translation from shapes");
...
disp("create base shape and base texture, and masks for each resolution is over");
%% D. Read images and get shape-free textures textures
disp("D. Read images and get shape-free textures textures");
...
iteration = 0;
max_iteration = 100;
disp("before loop in Procrustes_analysis");
